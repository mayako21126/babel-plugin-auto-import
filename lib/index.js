 ...
 * @LastEditors: mayako
 * @LastEditTime: 2020-04-14 17:34:21
 */
function getUrl(obj) {
  let tmp = []
...
autoImport.prototype.apply = function (compiler) {
  ...
  compiler.hooks.compilation.tap('autoImport', function (compilation, options) {
    compilation.hooks.htmlWebpackPluginBeforeHtmlProcessing.tap('autoImport', function (htmlPluginData, callback) {
      ...
      let tmp1 = setting.singleSpa ? 'if(!window.__POWERED_BY_QIANKUN__){if(v.length>0){add(["https://cdn.bootcss.com/es6-promise/4.1.1/es6-promise.auto.min.js"])};add(v)}else{add(assetsJs)}' : 'add(v)'
